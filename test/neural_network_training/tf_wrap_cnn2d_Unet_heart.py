...
def tf_prediction_func( model ):
    ...
    y1 = model.data + NNlayer.multi_convolution2d(model.data, cov_ker_size = cnn_ksize, n_cnn_layers = 2, \
                                           in_n_features_arr  = (1,  n_features), \
                                           out_n_features_arr = (n_features,  1), \
                                           pool_type = 'None', activate_type = 'sigmoid')
    y2 = y1 + NNlayer.multi_convolution2d(y1, cov_ker_size = cnn_ksize, n_cnn_layers = 2, \
                                           in_n_features_arr  = (1,  n_features), \
                                           out_n_features_arr = (n_features,  1), \
                                           pool_type = 'None', activate_type = 'sigmoid')
    y3 = y2 + NNlayer.multi_convolution2d(y2, cov_ker_size = cnn_ksize, n_cnn_layers = 2, \
                                           in_n_features_arr  = (1,  n_features), \
                                           out_n_features_arr = (n_features,  1), \
                                           pool_type = 'None', activate_type = 'sigmoid')
    ...
    conv1_12 = NNlayer.multi_convolution2d(y3, cov_ker_size = cnn_ksize, n_cnn_layers = 2, \
                                           in_n_features_arr  = (1,          n_features), \
