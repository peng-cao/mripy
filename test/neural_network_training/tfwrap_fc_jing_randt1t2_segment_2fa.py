...
#pathdat   = '/working/larson/UTE_GRE_shuffling_recon/circus_20171201_phantom/'
...
def tf_prediction_func( model ):
    ...
    #y5 = y4 + NNlayer.multi_full_connection(y4, n_fc_layers = 8,            activate_type = 'ReLU', layer_norm = 1) 
    #y6 = y5 + NNlayer.multi_full_connection(y5, n_fc_layers = 8,            activate_type = 'ReLU', layer_norm = 1) 
    #y7 = y6 + NNlayer.multi_full_connection(y6, n_fc_layers = 8,            activate_type = 'ReLU', layer_norm = 1) 
...
def test1():
    mat_contents  = sio.loadmat(pathdat+'dict_pca2.mat');#dict_pca
    ...
    for i in range(1000000):
        ...
        for dd in range(batch_xs.shape[0]):
            ...
            if normtc1  > 0.01: #and batch_ys[dd,0]*5000 > 3*500*batch_ys[dd,1] and batch_ys[dd,0]*5000 < 20*500*batch_ys[dd,1]
...
def test2():
    mat_contents     = sio.loadmat(pathdat+'im_pca2.mat')#im.mat
