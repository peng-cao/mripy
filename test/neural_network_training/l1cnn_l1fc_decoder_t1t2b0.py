...
def test():
    ...
    h_pool2_flat = tf.reshape(h_pool1, [-1, 5*3*64])
    ...
    y_conv = tf.sigmoid(tf.matmul(h_fcn_drop, W_fcn) + b_fcn)    
    ...
    for i in range(200000):
        ...
        if i%1000 == 0:
            ...
            saver.save(sess,pathexe + 'check_point/l1cnn_l1fc_dencoder_t1t2b0-mrf-ir-ssfp-noise0p01-20170507')    
